...
- Commits: `ec33358` red scaffold tests; `d91d53d` signed packaging; `81e3f9b` release governance; `24a8065` candidate CI; `375127b` stale-state hardening; `ea36d30` fixtures/handoff; this `[M4]` active-count hardening commit on `codex/model-overlay`.
